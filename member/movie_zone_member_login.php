<?php
/*-------------------------------------------------------------------------------------------------
@Module: movie_zone_member_login.php
...
if (isset($_SESSION['authorised']))
{
	...
	//if the keyword has been set, simply redirect user to index member page
	header("Location: movie_zone_member_index.php");
	die(); //and terminate
}
...
<html>
<head>
	<link rel='stylesheet' type='text/css' href='css/movie_zone_modal_dialog.css'>
...
<body>
	...
	<script>
		//simply goes back to the movie zone index file index.php
		...
		function login_btnOKClicked()
		{
			...
			makeAjaxPostRequest('movie_zone_member_main.php','cmd_member_login',formData, success);
		}
		//handle the server response.
		function success(data)
		{
			if (data == '_OK_')
			{ //ERR_SUCCESS == '_OK_' defined in movie_zone_member_config.php
				window.location.replace('movie_zone_member_index.php');
			}
			else
			{
