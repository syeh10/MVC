<?php
/*-------------------------------------------------------------------------------------------------
@Module: movie_zone_admin_login.php
...
--------------------------------------------------------------------------------------------------*/
	...
	if (isset($_SESSION['authorised'])) {
		...
		header("Location: movie_zone_admin_index.php");
		die(); //and terminate
	}
	...
	<!-- Modal content -->
		...
		<script>
			...
			function login_btnOKClicked() {
				...
				makeAjaxPostRequest('movie_zone_admin_main.php','cmd_admin_login',formData, success);
			}
			//handle the server response.
			function success(data) {
				if (data == '_OK_') { //ERR_SUCCESS == '_OK_' defined in movie_zone_admin_config.php
					window.location.replace('movie_zone_admin_index.php');
				} else {
